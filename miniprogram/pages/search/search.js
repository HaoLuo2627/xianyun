...
Page({
  ...
  bindClearHistory() {
    ...
    db.collection('history').doc('history' + this.data.openid).update({
      data: {
        historyList: []
      }
    }).then((res) => {
    ...
    db.collection('history').where({
      ...
      success: res => {
        ...
        if (!res.data.length) {
          ...
          db.collection('history').doc('history' + that.data.openid).update({
            data: {
  ...
  getHistory() {
    let that = this
    const db = wx.cloud.database()
    db.collection('history').doc('history' + that.data.openid).get({
      success(res) {
